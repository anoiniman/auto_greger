...
-- TODO, actually programme in the meta inventories in simplified/storeroom (we're not going to use simplified store-room) (we're not going to use simplified store-room)
...
-- TODO replace filint goal with pure gravel goal I guess
-- 03a
...
local __g_cobblestone01 = Goal:new(__g_logs02)

-- 01 (Should be able to craft the furnaces and chests by herself :))
